...
redis:set(max.."getidus"..msg.chat_id_, "Photo")
...
max..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
max..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
max..'addrd:'..msg.sender_user_id_,
max..'delrdall:'..msg.sender_user_id_,
max..":ForceSub:"..msg.sender_user_id_,
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/ahmedsiria/maxFILE/master/GetVersion.txt' ) or 0
...
keyboard = {} 
keyboard.inline_keyboard = { 
{{text = 'P𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑 SIRIA⁦♡⁩', url="t.me/SIRIA199"}}, 
{{text = 'DＥＶＥＬＯＰＥＲ OＲＡＢＩ𖤛', url="t.me/DEV_ORABI"}}, 
{{text = ' 𝐂𝐇𝐀𝐍𝐍𝐄𝑳 ＳＯＵＲＳＥ ＳＩＲＩＡ †࿃', url="t.me/SOURCE_SYRIA"}}, 
} 
...
ــــــــــــــــــــــــــــــــ☆max☆ـــــــــــــــــــــــــ
...
ـــــــــــــــــــــــــــــــــmaxــــــــــــــــــــــــ
 • مـعـرف الـمـطـــور : ]]..SUDO_USER..[[
]]
end
...
if welcome then
rules = (redis:get(max..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه .\n")
...
elseif Text== "سوريا" or Text== "احمد سوريا" then return  sendMsg(msg.chat_id_,msg.id_,"[ＳＩＲＩＡ᪥](https://t.me/SIRIA199)")
elseif Text== "عرابي" or Text== "جوكر راب" then return  sendMsg(msg.chat_id_,msg.id_,"[اجمد واحد ف التلي ♕](https://t.me/DEV_ORABI)")
...
ٴ≪━━━━━max━━━━━≫ٴ
 ...
 ✸ رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "احمد سوريا" or Text== " اباظه " or Text=="basel abaza" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/SIRIA199) ")
